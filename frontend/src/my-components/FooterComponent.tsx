...
const FooterComponent: React.FC = () => {
  return (
    <Footer
      ...
      style={{ backgroundColor: "#1a202c", color: "#cbd5e0" }}
    >
        ...
        <Row gutter={[32, 32]}>
          <Col xs={24} sm={24} md={8} lg={8}>
            ...
            <Text
              ...
              style={{ color: "white" }}
            >
              Empower your people. Simplify your HR. Let us handle your HR
              functions professionally so you can focus on what you do
              best—leading and growing your business.
            </Text>
            <Space size="middle">
              <a
                style={{ color: "white" }}
